...
class TransformsTestCase(unittest.TestCase):
    ...
    def __init__(self, *args, **kwargs):
        ...
        data_dict = {'mode': {0: 'Total', 1: 'Total', 2: 'Total'},
                     ...
                     'minutes': {0: pd.Timedelta('0 days 23:45:00'),
    ...
    def test_compute_oer(self):
        ...
        desired_series = pd.Series({
            0: 552. / (483.0 + 165.0 / 2 + 89.0 + 82.0),
            1: 528. / (490.0 + 124.0 / 2 + 75.0 + 96.0),
            2: 564. / (486.0 + 92.0 / 2 + 94.0 + 95.)
        },
            name='oer')
    ...
    def test_compute_total_possessions(self):
        ...
        desired_series = pd.Series({0: 483.0 + 165.0 / 2 + 89.0 + 82.0,
                                    1: 490.0 + 124.0 / 2 + 75.0 + 96.0,
                                    2: 486.0 + 92.0 / 2 + 94.0 + 95.0}, name='total_possessions')
